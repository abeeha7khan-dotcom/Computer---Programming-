...
02:Basic Data Types
Understanding int, float, double, char, and other types.
03:Basic Data Types
Understanding int, float, double, char, and other types
04:Strings 
Working with text using string class and character arrays.
05:Booleans
Using bool type (true/false) in decision making.
06:Conditions
Using if, else if, and else statements.
07: Switch
Multi-way selection using the switch statement.
08:Loops
Repeating tasks using for, while, and do-while loops.
09:Break / Continue
Controlling loop flow using break and continue.
10:Arrays
Storing multiple values using one-dimensional arrays.
11:Structures
